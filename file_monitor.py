...
█      ▐█ ███▄  █▄   ▄▀     █   █ ▀████ █ █  █ ▐█    █     ▀████ █  █  
 █      ▐     ▀ ▀███▀          █        █  █ █  ▐   ▀              █   
  ▀                           ▀         █   ██                    ▀  ''')
print('''#USAGE: In Windows, run filemonitor.py in a command prompt
# Now open another command prompt and run the following commands:
# "cd %temp%" 
 "echo hi > file1" ''')

dirs_to_monitor=["C:\\WINDOWS\\Temp",tempfile.gettempdir()]

# file modification constrants
FILE_CREATED=1
FILE_DELETED=2
FILE_MODIFIED=3
FILE_RENAMED_FROM=4
